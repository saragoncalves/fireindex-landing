...
export default function RootLayout({children}:{children:React.ReactNode}) { const structured={"@context":"https://schema.org","@type":"SoftwareApplication",name:"FireIndex",applicationCategory:"BusinessApplication",operatingSystem:"Web",url:SITE_URL,description:"Plataforma portuguesa de apoio à decisão para gestão operacional do risco meteorológico e de incêndio rural.",provider:{"@type":"Organization",name:"Bombeiros Voluntários de Albergaria-a-Velha"}}; return <html lang="pt-PT"><body><a className="skip-link" href="#conteudo">Saltar para o conteúdo</a><Header/><main id="conteudo">{children}</main><Footer/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(structured).replace(/</g,"\\u003c")}}/></body></html> }
